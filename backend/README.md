...
## Project Structure
    ...
    ├── testapiautosetting_124912  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124912`
...
2. Clone this repo and `cd testapiautosetting_124912`
